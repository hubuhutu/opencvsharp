...
namespace OpenCvSharp
{
	...
	public class CvSeq : CvTreeNode<CvSeq>, ICloneable
	{
		...
		public unsafe int Total => ((WCvSeq*)(void*)ptr)->total;

		public unsafe int ElemSize => ((WCvSeq*)(void*)ptr)->elem_size;

		public unsafe IntPtr BlockMax => new IntPtr(((WCvSeq*)(void*)ptr)->block_max);

		public unsafe IntPtr Ptr => new IntPtr(((WCvSeq*)(void*)ptr)->ptr);

		public unsafe int DeltaElems => ((WCvSeq*)(void*)ptr)->delta_elems;
		...
		{
			Cv.ContoursMoments(this, out CvMoments moments);
			return moments;
		}
		...
		{
			Cv.SeqPopFront(this, out T element);
			return element;
		}

		public T[] PopMulti<T>(int count, InsertPosition inFront) where T : struct
		{
			Cv.SeqPopMulti(this, out T[] elements, count, inFront);
			return elements;
		}
		...
		{
			Cv.StartAppendToSeq(this, out CvSeqWriter writer);
			return writer;
		}
