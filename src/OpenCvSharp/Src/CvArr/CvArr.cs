...
namespace OpenCvSharp
{
	...
	{
		public virtual int Dims => Cv.GetDims(this);

		public virtual MatrixType ElemType => (MatrixType)NativeMethods.cvGetElemType(base.CvPtr);
		...
		{
			Cv.ExtractMSER(this, mask, out CvContour[] contours, storage, @params);
			return contours;
		}
		...
		{
			Cv.Moments(this, out CvMoments moments, isBinary);
			return moments;
		}
