...
namespace OpenCvSharp.CPlusPlus
{
	internal class VectorOfVectorDMatch : DisposableCvObject, IStdVector<DMatch[]>, IDisposable
	{
		...
		public int Size1 {get{return NativeMethods.vector_vector_DMatch_getSize1(ptr).ToInt32();}}
        ...
        public IntPtr ElemPtr { get { return NativeMethods.vector_vector_DMatch_getPointer(ptr); } }
