...
namespace OpenCvSharp.CPlusPlus
{
	internal class VectorOfVectorFloat : DisposableCvObject, IStdVector<float[]>, IDisposable
	{
		...
		public int Size1 {get{return NativeMethods.vector_vector_float_getSize1(ptr).ToInt32();}}
        ...
        public IntPtr ElemPtr { get { return NativeMethods.vector_vector_float_getPointer(ptr); } }
