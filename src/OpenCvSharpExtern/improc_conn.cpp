...
int connectedComponents(InputArray img_, OutputArray _labels, int connectivity, int ltype) {
	return connectedComponents(img_, _labels, connectivity, ltype, CCL_DEFAULT);
}
...
{
	return connectedComponentsWithStats(img_, _labels, statsv, centroids, connectivity, ltype, CCL_DEFAULT);
}
